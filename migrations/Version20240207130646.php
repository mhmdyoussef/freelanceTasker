 ...
 */
final class Version20240207130646 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, client_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, domain_name VARCHAR(255) NOT NULL, credentials CLOB NOT NULL, estimated_price NUMERIC(10, 2) DEFAULT NULL, hourly_rate NUMERIC(5, 2) DEFAULT NULL, platform VARCHAR(255) NOT NULL, CONSTRAINT FK_2FB3D0EE19EB6921 FOREIGN KEY (client_id) REFERENCES client (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
